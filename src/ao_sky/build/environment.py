...
from .config import resolve_gaia_root_only, resolve_runtime_root_candidates
...
def fetch_gaia_data(
    *,
    ...
    """Fetch Gaia TGE dust plus one full Gaia store and return the summary path."""
    ...
    fetch_gaia_tge_dataset(resolved_gaia_root)

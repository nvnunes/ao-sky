...
class TraversalExecutionConfig:
    ...
    on_axis_backend_buckets: tuple[int, ...] = DEFAULT_BACKEND_BUCKETS
    legacy_field_averaged_backend_buckets: tuple[int, ...] = DEFAULT_BACKEND_BUCKETS
    prediction_cache_clear_every: int = -1
...
class TraversalStructureStats:
    ...
    on_axis_prediction_backend_bucket_counts: tuple[tuple[int, int], ...] = ()
    on_axis_prediction_backend_bucket_rows: tuple[tuple[int, int], ...] = ()
    ...
    field_averaged_prediction_backend_bucket_counts: tuple[tuple[int, int], ...] = ()
    field_averaged_prediction_backend_bucket_rows: tuple[tuple[int, int], ...] = ()
...
class TraversalMemorySample:
    ...
    on_axis_prediction_backend_rows: int = 0
    on_axis_prediction_backend_batch_rows_peak: int = 0
    on_axis_prediction_backend_bucket_counts: str = ""
    on_axis_prediction_backend_bucket_rows: str = ""
    on_axis_feature_mib_peak: float = 0.0
    on_axis_mps_current_mib_peak: float = 0.0
    on_axis_mps_driver_mib_peak: float = 0.0
    on_axis_mps_recommended_mib: float = 0.0
    field_averaged_prediction_batches: int = 0
    field_averaged_prediction_rows: int = 0
    field_averaged_prediction_batch_rows_peak: int = 0
    field_averaged_prediction_backend_rows: int = 0
    field_averaged_prediction_backend_batch_rows_peak: int = 0
    field_averaged_prediction_backend_bucket_counts: str = ""
    field_averaged_prediction_backend_bucket_rows: str = ""
    field_averaged_feature_mib_peak: float = 0.0
    field_averaged_mps_current_mib_peak: float = 0.0
    field_averaged_mps_driver_mib_peak: float = 0.0
    field_averaged_mps_recommended_mib: float = 0.0
